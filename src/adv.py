# room == name of the file - room namespace/library/module
# Room == Room class from the room.py file
...
earlier adventurers. The only exit is to the south.""", [Diamond("diamond", "A diamond of pure light, shimmering in the soft torch-ligth.", "$20,000,000", "white")]),
}
